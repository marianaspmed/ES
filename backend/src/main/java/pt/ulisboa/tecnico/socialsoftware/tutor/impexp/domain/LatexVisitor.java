...
public abstract class LatexVisitor implements Visitor {
    ...
    public void visitQuestionDetails(OpenEndedQuestion question) {
        ...
        this.result = this.result + "\\putAnswers\n";

        this.result = this.result + "% AnswerField: " + question.getCorrectAnswerRepresentation() + "\n";

        this.result = this.result + "% Regex: " + question.getRegex() + "\n";
    ...
    public void visitQuestionDetails(ItemCombinationQuestion question) {
        ...
        this.result = this.result + question.getCorrectAnswerRepresentation();
        this.result = this.result + "\\end{lstlisting}\n";
