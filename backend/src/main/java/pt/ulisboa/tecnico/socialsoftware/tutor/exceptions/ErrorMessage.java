...
public enum ErrorMessage {
    ...
    ANSWER_IS_NULL("Answer can't be null"),
    REGEX_IS_NULL("Regex can't be null"),
    ...
    DUPLICATED_RELEVANCY("Question's different correct options' mustn't have the same relevancy"),
    INVALID_RELEVANCY_ASSIGNMENT("Question's non correct options mustn't have assigned relevancy"),
    INVALID_RELEVANCY_ORDER("Question's correct options' relevancy's set must be consecutive numbers"),
    MUST_ASSIGN_RELEVANCY("Question's correct options must have an assigned relevancy"),
    ...
    //  PCI
    ONE_CORRECT_OPTION_NEEDED("Questions need to have at least 1 correct option"), //changed for pem
    AT_LEAST_TWO_ITEM_SETS_NEEDED("Item Combination Questions need to have at least 2 item sets."),
    AT_LEAST_ONE_CORRESPONDENCE_NEEDED("Item Combination Questions need to have at least one correspondence between sets."),
    MISMATCHED_CORRESPONDENCES("Item Combination Questions need to have matching sequence number correpondences."),
    QUESTION_ORDER_PCI_OPTION_MISMATCH("Question %d does not have option %d"),
    ...
    QUESTION_WITHOUT_ANSWER("Question doesn't have an answer"),
    QUESTION_WITHOUT_REGEX("Question doesn't have a regular expression"),
