...
class ImportExportOpenEndedQuestionsTest extends SpockTest {
    ...
    def setup() {
        ...
        def openEndedQuestion = new OpenEndedQuestionDto()
        openEndedQuestion.setAnswerField(ANSWER_1)
        openEndedQuestion.setRegex(REGEX_1)
    ...
    def 'export and import questions to xml'() {
        ...
        questionResult.getQuestionDetailsDto().getAnswerField() == ANSWER_1
        questionResult.getQuestionDetailsDto().getRegex() == REGEX_1
