...
class RemoveQuestionTest extends SpockTest {
    ...
    def "remove a pci question"() {
        ...
        when:
        questionService.removeQuestion(pciQuestion.getId())
    ...
    def "remove a pra question"() {
        ...
        def questionDetails2 = new OpenEndedQuestion()
        praQuestion.setQuestionDetails(questionDetails2)
        questionDetailsRepository.save(questionDetails2)
        questionRepository.save(praQuestion)
        when:
        questionService.removeQuestion(praQuestion.getId())
    ...
    def "remove a pem used in a quiz"() {
        given: "a question with answers"
        Quiz quiz = new Quiz()
        quiz.setKey(1)
        quiz.setTitle(QUIZ_TITLE)
