...
Cypress.Commands.add(
  'createSimplePCIQuestion',
  (title, question, leftOption, rightOption) => {
    cy.get('[data-cy="managementMenuButton"]').click();
    cy.get('[data-cy="questionsTeacherMenuButton"]').click();
    ...
    cy.get('[data-cy="questionOptionsInputLeft_1"]')
      .within(($ls) => {
        cy.get('[data-cy="Option 1"]').type(leftOption);
      });
    cy.get('[data-cy="questionOptionsInputRight_1"]')
      .within(($ls) => {
        cy.get('[data-cy="Option 1"]').type(rightOption);
      });
...
Cypress.Commands.add(
    'createSimplePRAQuestion',
    (title, question, answerField, regex) => {
        cy.get('[data-cy="managementMenuButton"]').click();
        cy.get('[data-cy="questionsTeacherMenuButton"]').click();
